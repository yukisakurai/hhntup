...
class MMC(object):
    ...
    def mass(self,
        ...
        for method in range(3):
            ...
            MMC_nu1 = ROOT.TLorentzVector(0, 0, 0, 0)
            MMC_nu2 = ROOT.TLorentzVector(0, 0, 0, 0)
            MMC_vistau1 = ROOT.TLorentzVector(0, 0, 0, 0)
            MMC_vistau2 = ROOT.TLorentzVector(0, 0, 0, 0)
            if self.tool.GetFitStatus() == 1:
                ...
                MMC_nu1 = self.tool.GetNeutrino4vec(method,0)
                MMC_nu2 = self.tool.GetNeutrino4vec(method,1)
                MMC_vistau1 = MMC_tau1 - MMC_nu1
                MMC_vistau2 = MMC_tau2 - MMC_nu2
            result[method] = (MMC_mass, MMC_resonance, MMC_met, \
                                  MMC_tau1,MMC_tau2, \
                                  MMC_nu1,MMC_nu2, \
                                  MMC_vistau1,MMC_vistau2)
        return result
